...
def get_llmm(model="gemini-2.5-flash"):
...
def get_retriever():
    ...
    database = PineconeVectorStore.from_existing_index(embedding=emb, index_name=index_name)
...
def get_ai_response(user_message):
    # llm_ollama = ChatOllama(model="hf.co/unsloth/Qwen2.5-Omni-7B-GGUF:Q4_K_XL")
